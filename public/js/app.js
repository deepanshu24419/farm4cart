...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (productItem) {
      return "\n                <p>".concat(productItem.item.name, " - ").concat(productItem.qty, " flat </p>\n            ");
    }).join("");
  }
...
__webpack_require__(/*! D:\farm4cart\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\farm4cart\resources\scss\app.scss */"./resources/scss/app.scss");
